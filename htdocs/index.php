...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="images/demo/slider/11.png" alt=""></a>
        <figcaption>
          <h2>Uygulama 1</h2>
          <p>Fonksiyon </p>
          <!-- -->
...
echo generateCreditCardTable("1111 1111 1111 0000", "09/27", "2363");
      ...
      <figure id="slide-3"><a class="view" href="#"><img src="images/demo/slider/3.png" alt=""></a>
        <figcaption>
          <h2>uygulama 3</h2>
          <p>Fonksiyon uygulama 3</p>
          <p>
            <?php  
                    echo "<Table Bordert=25 cellpadding=25>";
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="images/demo/slider/4.png" alt=""></a>
        <figcaption>
          <h2>uygulama 4</h2>
          <p>Fonksiyon uygulama 4</p>
          <p>
            <?php 
            $tr=3600;
            $dCeviri=dolarCeviri($tr);
            $eCeviri=euroCeviri($tr);
            $sCeviri=sterlinCeviri($tr);
                          function dolarCeviri($tutar){
              return($tutar/8);
             }
                          function euroCeviri($tutar){
              return($tutar/10);
             }
                          function sterlinCeviri($tutar){
              return($tutar/12);
             }
             echo "dolarKuru:$dCeviri  <br>";
             echo "euroKuru:$eCeviri  <br>";
             echo "sterlinKuru:$sCeviri ";
            ?>
          </p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
        </figcaption>
      ...
      <!-- ################################################################################################ -->
      <ul id="slide-tabs">
        <li><a href="#slide-1">Uygulama 1</a></li>
        <li><a href="#slide-2">Uygulama 2</a></li>
        <li><a href="#slide-3">Uygulama 3</a></li>
        <li><a href="#slide-4">Uygulama 4</a></li>
        <li><a href="#slide-5">Uygulama 5</a></li>
      </ul>
      <!-- ################################################################################################ --> 
    </div>
  </div>
